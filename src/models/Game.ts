import { User, UserWithReady } from "./User";
...
export class Game {
  ...
  constructor(code: string, isPublic: boolean = false, owner: User = new User(), users: UserWithReady[] = [], password: string | null = null, usePublicQuestions = true, usePrivateQuestions = true) {
    this.code = code;
