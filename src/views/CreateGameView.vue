  ...
  <div class="createGameView">
    <div class="createGameView_card">
      <div class="whiteCard">
        ...
        <div class="settings">
          <v-switch class="settings_switch" v-model="newGame.usePrivateQuestions" label="Używaj prywatnych pytań" inset hide-details color="orange" />
          <v-switch class="settings_switch" v-model="newGame.usePublicQuestions" label="Używaj publicznych pytań" inset hide-details color="orange" />
          <v-switch class="settings_switch" v-model="newGame.isPublic" label="Gra widoczna na liście" inset hide-details color="orange" />
        </div>
        <div v-if="!newGame.isPublic" class="customCodeSection">
          <p class="customCodeSection_description">Zaproś pozostałych podając kod:</p>
        ...
        <div class="publicSection" v-else>
          ...
          hide-details
          />
          <span class="publicSection_info">* Bez ustawienia hasła każdy będzie mógł dołączyć do Twojego pokoju.</span>
        </div>
        <div class="controls">
